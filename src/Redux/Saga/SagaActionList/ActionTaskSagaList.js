...
import { CHANGE_STATUS, CLOSE_DRAWER, CREATE_NEW_TASK, GET_ALL_PROJECTS, GET_ALL_TASK_STATUS, GET_ALL_USERS, GET_PRIORITY_LIST, GET_PROJECT_INFO_BY_ID, GET_TASK_DETAIL_BY_ID, GET_TASK_TYPE, REMOVE_ASSIGNESS, STORE_ALL_TASK_STATUS, STORE_ALL_USERS, STORE_PRIORITY_LIST, STORE_TASK_DETAIL, STORE_TASK_TYPE, UPDATE_ASSIGNESS, UPDATE_DESCRIPTION, UPDATE_DESCRIPTION_TO_API, UPDATE_ESTIMATE_TIME, UPDATE_PRIORITY, UPDATE_STATUS, UPDATE_STATUS_TO_API, UPDATE_TASK_TO_API } from '../../ReduxTypeList/typeList';
  // ========== GET TASK TYPE ==========
